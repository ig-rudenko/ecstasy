<template>
  <!--  CPU-->
<div>
  <div class="btn" v-if="stats.cpu">
    <svg v-bind:fill="value_color(Math.max(...stats.cpu.util))"
    ...
    cpu {{stats.cpu.util.join("% | ")}}%
  </div>
</div>

  <!--  RAM-->
<div>
  <div class="btn" v-if="stats.ram">
    <svg v-bind:fill="value_color(stats.ram.util)"
  ...
  <!--  FLASH-->
<div>
  <div class="btn" v-if="stats.flash">
    <svg v-bind:fill="value_color(stats.flash.util)"
    ...
    flash {{stats.flash.util}}%
  </div>
</div>

  <!--  TEMP-->
<div>
<div class="btn" v-if="stats.temp">
    <!--LOW-->
