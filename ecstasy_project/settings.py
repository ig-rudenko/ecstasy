...
from ecstasy_project import admin_theme
from ecstasy_project.settings_utils import env_bool, env_int
...
UNFOLD: dict[str, object] = admin_theme.UNFOLD
...
if env_bool("DJANGO_COLLECT_STATIC"):
...
CELERY_TASK_ALWAYS_EAGER = env_bool("CELERY_TASK_ALWAYS_EAGER", ENV == "dev")
...
KEYCLOAK_ENABLE = env_bool("KEYCLOAK_ENABLE")
KEYCLOAK_JWT_LEEWAY = env_int("KEYCLOAK_JWT_LEEWAY", 0)
...
if KEYCLOAK_ENABLE:
    ...
    OIDC_USE_PKCE = True
    OIDC_CREATE_USER = env_bool("OIDC_CREATE_USER")
...
VERIFY_ZABBIX_CONNECTION = env_bool("VERIFY_ZABBIX_CONNECTION", True)
DATA_UPLOAD_MAX_NUMBER_FIELDS = env_int("DJANGO_DATA_UPLOAD_MAX_NUMBER_FIELDS", 3000)
