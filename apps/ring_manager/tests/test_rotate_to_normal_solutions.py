...
from apps.check.models import AuthGroup, Devices
...
class TestRotateToNormalSolutions(TestRingBase):
    ...
    @patch("apps.check.models.Devices.available", return_value=False)
    ...
    def test_perform_solutions_ok(self, *args):
        ...
        remote_connector.set_connector(
            "apps.ring_manager.tests.test_rotate_to_normal_solutions.FakeTailAndDev3Session"
        )
