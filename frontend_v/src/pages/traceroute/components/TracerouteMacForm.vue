                ...
                <div class="flex gap-2 items-end">
                    <div class="min-w-0">
                        ...
                        <InputText
                            ...
                            class="h-10! w-full rounded-2xl text-center font-mono bg-white/95! text-gray-900! dark:bg-gray-950/60! dark:text-gray-100! border-gray-200/80! dark:border-gray-700/60!"
                    ...
                    <div class="min-w-0">
                        ...
                        <InputNumber
                            ...
                            :max="4096"
                            class="block w-full"
                            input-class="h-10! w-full rounded-2xl text-center font-mono bg-white/95! dark:!bg-gray-950/60 !text-gray-900 dark:!text-gray-100 !border-gray-200/80 dark:!border-gray-700/60"
