...
<template>
    ...
    <div class="flex justify-start items-center h-screen">
        <div class="flex flex-col gap-3 mx-6 w-full md:mx-20 md:w-[20rem]">
            <h1 class="mb-4 text-2xl md:w-[20rem] text-center text-gray-200">
                Пожалуйста, войдите в систему <span class="font-mono">Ecstasy</span>
            </h1>
            ...
            <div>
                <IftaLabel>
                    <InputText
                        id="username"
                        class="bg-gray-950 border-gray-800 text-gray-200 font-mono rounded-2xl"
            ...
            <div>
                <IftaLabel>
                    <Password
                        id="password"
                        input-class="bg-gray-950 border-gray-800 text-gray-200 font-mono rounded-2xl"
                        @keydown.enter="handleLogin"
                        fluid
                        :feedback="false"
            ...
            <Button
                ...
                fluid
                outlined
                class="w-full mt-4 hover:bg-primary hover:text-primary-contrast rounded-2xl border-0 bg-gray-950"
            />
            <Button
                v-if="oidcState.enabled"
                type="button"
                ...
                fluid
                text
                class="w-full hover:bg-primary hover:text-primary-contrast rounded-2xl border-0 bg-gray-950"
            />
            <div>
                <i
                    v-tooltip="'Перезапросить'"
                    @click="logout"
                    class="pi pi-wrench text-gray-600 hover:text-gray-100 cursor-pointer"
                />
            </div>

            <p class="mt-5 text-muted-color text-center font-mono">
                Ecstasy &copy; 2022-{{ new Date().getFullYear() }}
            </p>
        </div>
    </div>
</template>
