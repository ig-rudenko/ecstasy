            ...
            <div v-if="rings.list.length" class="grid gap-5 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                ...
                >
                    <div class="flex items-start justify-between gap-4">
                        <div
                            class="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-100 text-indigo-600 dark:bg-indigo-500/15 dark:text-indigo-300"
                        >
                            <svg
                    ...
                    <div
                        class="mt-5 inline-flex items-center gap-2 text-sm font-medium text-indigo-600 dark:text-indigo-300"
                    >
                        Открыть кольцо
...
export default {
    ...
    computed: {
        filteredRings() {
            ...
            return Array.from(this.rings.list).filter((ring) => {
