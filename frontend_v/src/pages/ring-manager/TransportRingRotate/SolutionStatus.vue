<template>
    <div class="solution-status">
        ...
        <!--ДОСТУПНО-->
        <div v-else-if="status === 'done'" v-tooltip="'Успешно выполнено'">
        ...
        <div v-else v-tooltip="errorMessage">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="red" viewBox="0 0 16 16">
                <path
