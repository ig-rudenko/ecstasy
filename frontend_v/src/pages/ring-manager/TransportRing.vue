    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        <div v-if="rings.selectedRing === null" class="flex flex-col gap-6">
            ...
            <div v-if="rings.list.length" class="grid gap-5 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                ...
                >
                    <div
                        class="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-600 dark:bg-emerald-500/15 dark:text-emerald-300"
                    >
                        <svg
                    ...
                    <div
                        class="mt-5 inline-flex items-center gap-2 text-sm font-medium text-emerald-600 dark:text-emerald-300"
                    >
                        Открыть кольцо
