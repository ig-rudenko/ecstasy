            ...
            <div v-if="current_step === 1" class="p-4">
                <div class="flex flex-col sm:grid grid-cols-3 gap-4">
                    <div class="me-3 w-full col-span-2">
                        ...
                        <Select
                            v-model="formData.oltState.deviceName"
                            :options="devicesList"
                            filter
                    ...
                    <div class="me-3 w-full">
                        ...
                        <Select
                            v-model="formData.oltState.devicePort"
                ...
                <div class="w-100">
                    ...
                    <InputText
                        v-model.trim="formData.oltState.fiber"
                        fluid
                        class="rounded-2xl"
                ...
                <div>
                    ...
                    >
                        ...
                        <InputText
                            ...
                            v-model.trim="formData.houseB.entrances"
                            fluid
                    ...
                    <div>
                        ...
                        <Textarea
                            v-model="formData.houseB.description"
                            rows="5"
                            fluid
                            auto-resize
                            class="rounded-2xl"
            ...
            <div v-else-if="current_step === 3" class="p-4">
                <div v-if="formData.houseB.buildType() === 'house'" class="flex justify-center flex-col gap-2">
                    ...
                    <div class="self-center w-full">
                        <SplittersRizersFind
                            :init="formData.end3.existingSplitter"
                            :type="formData.end3.type"
                            :getFromOLTState="formData.oltState"
                            @change="
                                (e) => {
                                    formData.end3.existingSplitter = e.value;
                                }
                            "
                        >
                        </SplittersRizersFind>
                ...
                <div class="flex">
                    ...
                    <div v-if="formData.end3.type === 'rizer'">
                        <div>
                            ...
                            <Select
                                v-model="formData.end3.portCount"
                                :options="[4, 8, 12, 16, 24]"
                                class="md:w-14rem me-3"
                            />
                            <Button
                                @click="formState.thirdStep.showRizerColors = true"
                                severity="primary"
                                icon="pi pi-palette"
                                outlined
                        ...
                        <Dialog v-model:visible="formState.thirdStep.showRizerColors">
                            <RizerFiberColorExample
                                v-if="formData.end3.type === 'rizer'"
                                :count="formData.end3.portCount"
                            />
                        </Dialog>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr v-if="formData.end3.existingSplitter" class="odd:bg-gray-200 dark:odd:bg-gray-700">
                            ...
                            <td class="p-2">
                                ...
                                Локация: {{ formData.end3.existingSplitter.location }}. Кол-во портов:
                                {{ formData.end3.existingSplitter.capacity }}
                            </td>
                        </tr>
