                ...
                <div class="flex flex-wrap">
                    <div style="width: 300px" class="me-2">
                        ...
                        <InputText
                            ...
                            v-model.trim="filter.deviceName"
                            type="text"
                            @keydown.enter="doFilter"
                        />
                    </div>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="items-center flex font-bold py-2 px-10 gap-3">
                            ...
                            <div>
                                <router-link
                                    :to="{ name: 'gpon-building-tech-data', params: { id: line.building_id } }"
                                    class="address-name dark:text-gray-300"
                            ...
                            <div class="items-center flex gap-2 px-10">
                                ...
                                <router-link
                                    :to="{
                                        ...
                                        params: { deviceName: line.deviceName },
                                        query: { port: line.devicePort },
                                    }"
                                >
                        ...
                        <td>
                            <div class="px-10 flex items-center gap-2">
                                <Pill
                                    :text="
                                        customerLineTypeName(line.customerLine.type) +
                                        ' x' +
                                        line.customerLine.typeCount
                                    "
