    ...
    <div class="table-plate rounded-3xl">
        <div>
            <div class="flex flex-wrap sm:flex-nowrap items-center gap-2 p-4">
                ...
                <InputText
                    id="filter-region"
                    v-model.trim="filter.general"
                    fluid
                    @keydown.enter="doFilter"
                    placeholder="ФИО, транзит или номер телефона"
                />
            </div>
            ...
            >
                <div class="flex flex-wrap">
                    <div style="width: 200px" class="me-2">
                        ...
                        <InputText
                            style="width: 200px"
                            id="filter-region"
                            v-model.trim="filter.address.region"
                            type="text"
                            @keydown.enter="doFilter"
                        />
                    </div>
                    <div style="width: 200px" class="me-2">
                        ...
                        <InputText
                            ...
                            v-model.trim="filter.address.settlement"
                            type="text"
                            @keydown.enter="doFilter"
                        />
                    </div>
                    <div style="width: 200px" class="me-2">
                        ...
                        <InputText
                            style="width: 200px"
                            id="filter-planStructure"
                            v-model.trim="filter.address.planStructure"
                            @keydown.enter="doFilter"
                        />
                    </div>
                </div>
                ...
                <div class="flex flex-wrap">
                    <div style="width: 300px" class="me-2">
                        ...
                        <InputText
                            style="width: 300px"
                            id="filter-street"
                            v-model.trim="filter.address.street"
                            type="text"
                            @keydown.enter="doFilter"
                        />
                    </div>
                    <div style="width: 100px" class="me-2">
                        ...
                        <InputText
                            style="width: 100px"
                            id="filter-house"
                            v-model.trim="filter.address.house"
                            type="text"
                            @keydown.enter="doFilter"
                        />
                    </div>
                    <div style="width: 100px" class="me-2">
                        ...
                        <InputText
                            style="width: 100px"
                            id="filter-block"
                            v-model.number="filter.address.block"
                            type="text"
                            @keydown.enter="doFilter"
                        />
                    </div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <Button class="search-button dark:!text-white" outlined severity="success" @click="doFilter"
                        >Поиск</Button
                    >
                </div>
            </div>
                    ...
                    >
                        ...
                        <td class="flex flex-col font-bold dark:text-gray-300">
                            <div class="flex items-center font-bold p-4 pb-0 px-10 gap-3 dark:text-gray-300">
                                <router-link
                                    :to="{ name: 'gpon-view-subscriber', params: { id: line.customer.id } }"
                                    class="hover:text-primary"
                                >
                                    {{ line.customer.surname }} {{ line.customer.firstName }}
                                    {{ line.customer.lastName }}
                            ...
                            <div class="px-10 secondary-text pb-2">
                                Дата подключения: {{ verboseDate(line.connected_at) }}
                            </div>
                        </td>
                        ...
                        <td class="dark:text-gray-300 p-2">
                            <div>
                                ...
                                <span class="font-bold" v-if="line.address.apartment"
                                    >кв. {{ line.address.apartment }}</span
                                >
                                <br />
                        ...
                        <td class="p-2">
                            <Pill
                                :text="customerTypeName(line.customer.type)"
                            ...
                            <span class="secondary-text">
                                <span
                                    >Транзит: <span class="font-mono">{{ line.transit }}</span></span
                                >
                            </span>
                        </td>
                        ...
                        <td>
                            <div class="flex flex-col gap-1 px-3">
                                <span v-for="service in line.services" class="secondary-text font-mono">{{
                                    service
                                }}</span>
                            </div>
                        </td>
