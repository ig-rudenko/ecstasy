    ...
    <div>
        <div class="flex justify-between gap-4">
            ...
            <div class="w-full flex flex-col gap-2">
                ...
                <InputText
                    v-model.trim="address.settlement"
        ...
        <div>
            ...
            <InputText
                v-model.trim="address.planStructure"
                :class="planStructureClasses"
                fluid
                class="rounded-2xl w-full"
                ...
                <template v-else>
                    ...
                    <div class="me-3">
                        ...
                        <InputNumber
                            :input-style="{ width: '200px' }"
                            :min="1"
                            v-model.number="address.total_entrances"
                            class="rounded-2xl"
                        />
                    </div>
                </template>
...
export default {
    ...
    methods: {
        ...
        validate() {
            ...
            if (
                this.region.valid &&
                this.settlement.valid &&
                this.planStructure.valid &&
                this.street.valid &&
                this.house.valid
            ) {
