<template>
    ...
    <div class="flex flex-wrap py-4 justify-center">
        <div
            v-for="(sp, index) in initial"
            class="border border-gray-300 dark:border-gray-800 rounded-xl p-3 m-2 relative"
        >
            <!-- Удаление -->
            ...
            <div v-if="end3Type === 'splitter'" class="my-2">
                <div>
                    ...
                    <div class="flex align-items-center py-2">
                        <ToggleSwitch
                            :input-id="'splitter-address-' + index"
                            v-model="sp.buildAddress"
                            :binary="true"
                        />
    ...
    <div>
        <Button @click="addNew" outlined size="small" class="rounded-2xl">
