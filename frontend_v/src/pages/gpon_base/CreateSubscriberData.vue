<template>
    ...
    <div class="pb-15">
        ...
        <div
            class="md:border rounded-3xl md:shadow py-4 pb-8 px-2 xl:w-2/3 mx-auto border-gray-300 dark:border-gray-700"
        >
            <StepMenu
                class="p-2"
            ...
            <div v-if="current_step === 1" class="p-4">
                ...
                <div class="flex items-center flex-wrap gap-3">
                    <div class="py-2 w-full sm:w-1/2">
                        ...
                        <Select
                            v-model="formData.techData.deviceName"
                            :options="devicesList"
                            filter
                            :option-label="(x) => x"
                            fluid
                    ...
                    <div v-if="formData.techData.deviceName" class="w-full sm:w-1/3">
                        ...
                        <Select
                            v-model="formData.techData.devicePort"
                ...
                <div v-if="formData.techData.address">
                    ...
                    <SplittersRizersFind
                        @change="
                            (e) => {
                                formData.techData.end3 = e.value;
                                end3HasChanged();
                            }
                        "
                ...
                <div v-if="formData.techData.end3 && formData.techData.address">
                    ...
                    <SelectSplitterRizerPort
                        :init="formData.techData.end3Port"
                        :valid="formState.firstStep.end3Port.valid"
                        :end3ID="formData.techData.end3.id"
                        @change="
                            (e) => {
                                formData.techData.end3Port = e.value;
                                formState.firstStep.end3Port.valid = true;
                            }
                        "
            ...
            <div v-else-if="current_step === 2" class="p-4">
                    ...
                    >
                        <template #value="slotProps">
                            <div
                                ...
                                v-html="subscriberVerbose(slotProps.value)"
                            ></div>
                            <span v-else>{{ slotProps.placeholder }}</span>
                        </template>
                        <template #option="slotProps">
                ...
                <div v-if="formData.customer.type === 'person'" class="flex flex-wrap">
                    <div class="input-part">
                        ...
                        <InputText
                            :disabled="formState.secondStep.selected"
                            v-model.trim="formData.customer.surname"
                            fluid
                            class="rounded-2xl"
                ...
                <div class="flex flex-wrap py-2">
                    <div class="input-part">
                        ...
                        <InputText
                            :disabled="formState.secondStep.selected"
                            v-model.number="formData.customer.contract"
                            type="number"
                            style="width: 100%"
                            class="rounded-2xl"
                ...
                <div class="flex flex-wrap gap-4 p-2">
                    ...
                    <div class="flex items-center gap-2 select-none">
                        <Checkbox v-model="formData.services" input-id="service-tv" value="tv" class="rounded-3xl" />
                        <label for="service-tv" class="cursor-pointer"> Телевидение </label>
                    </div>
                    <div class="flex items-center gap-2 select-none">
                        <Checkbox
                            v-model="formData.services"
                            input-id="service-voip"
                            value="voip"
                            class="rounded-3xl"
                        />
            ...
            <div v-else-if="current_step === 3" class="p-4">
                <div class="px-2">
                    <AddressGetCreate
                        :data="formData"
                        :valid="formState.thirdStep.address.valid"
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="input-part">
                        ...
                        <InputText
                            v-model.trim="formData.ont_serial"
                            type="text"
                            style="width: 100%"
                            class="rounded-2xl"
                        />
                ...
                <table>
                    <tbody class="text-[1.1rem]">
                        <tr v-if="formData.customer.type === 'person'" class="bg-gray-200 dark:bg-gray-700">
                            <td class="p-2">ФИО</td>
                            <td class="p-2">
                                {{ formData.customer.firstName }} {{ formData.customer.surname }}
                                {{ formData.customer.lastName }}
                                <Message
                                    v-if="customerFirstNameError || customerSurnameError || customerLastNameError"
                                    severity="error"
                                >
                    ...
                    <tbody class="text-[1.1rem]">
                        ...
                        <tr class="bg-gray-200 dark:bg-gray-700">
                            ...
                            <td class="p-2">
                                ...
                                <Message v-if="connectedDatetimeError" severity="error">{{
                                    connectedDatetimeError
                                }}</Message>
                            </td>
                        </tr>
                    ...
                    isValid() {
                        return (
                            ((this.subscriberType === "person" &&
                                this.person.firstName.valid &&
                                this.person.surname.valid &&
                                this.person.lastName.valid) ||
