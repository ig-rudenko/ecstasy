        ...
        <div v-else id="tech-data-block" class="px-10 py-5 border border-gray-300 dark:border-gray-800 rounded-4xl">
            <div class="flex items-center justify-center flex-wrap">
                <div class="flex flex-col">
                    ...
                    <AddressGetCreate
                        v-if="editMode && hasPermissionToUpdateEnd3"
                        :is-mobile="isMobile"
                        :allow-create="true"
                        :data="detailData"
                    />
                ...
                <div class="m-2">
                    <svg
                        v-if="detailData.type === 'rizer'"
                        style="transform: rotate(300grad)"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 26 32"
                        width="128"
                        height="128"
                    >
                        <path
                            fill="#e6e6e6"
                            d="M23 0H3a1 1 0 0 0-1 1v20a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"
                            class="colore6e6e6 svgShape"
                        ></path>
                        <path
                            fill="#cccccc"
                            d="M25 10H1a1 1 0 1 0 0 2h24a1 1 0 1 0 0-2z"
                ...
                <div>
                    <template v-if="editMode && hasPermissionToUpdateEnd3 && hasPermissionToUpdateTechCapability">
                        <div class="flex items-center flex-wrap gap-3">
                            ...
                            <Select
                                v-model.number="detailData.capacity"
                        ...
                        <Message class="my-2" severity="warn">
                            Будьте осторожны при выборе новой ёмкости! Данное действие необходимо только после
                            физического переключения линии либо в случае ошибки.
                        </Message>
                    </template>
            ...
            if (this.detailData.capacity < this.originalCapacity) {
                if (this.deletionUsersAffected()) {
                    ...
                    this.capacityWarning =
                        "Изменение затронет существующие подключения абонентов. " +
                        "Необходимо их перенести на другую линию, а затем изменить ёмкость.";
                } else {
                    this.errorSeverity = "warn";
                    this.capacityWarning =
                        "Внимание, вы указали ёмкость меньше, чем была изначально! Будут удалены последние записи";
                }
