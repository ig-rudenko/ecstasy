        ...
        <div id="subscriber-data-block">
            <div v-if="customer" class="flex flex-wrap items-center justify-center">
                <img
                    ...
                    :src="'/img/gpon/subscriber-' + gender + '.svg'"
                ...
                >
                    ...
                    <div class="text-secondary flex items-center gap-2 py-4">
                        ...
                        <InputText
                            v-if="editMode"
                            v-model.trim="customer.contract"
                            type="text"
                            style="width: 100%"
                            class="rounded-2xl"
                        />
            ...
            <div class="mx-auto xl:w-3/4">
                <div v-if="customer">
                    ...
                    <div
                        v-for="connection in customer.connections"
                        class="sm:border border-gray-300 dark:border-gray-800 rounded-xl shadow mb-4 relative"
                    >
                        <!-- УДАЛЕНИЕ ПОДКЛЮЧЕНИЯ -->
                        <div
                            v-if="editMode && hasPermissionToDeleteConnection"
                            class="md:absolute p-4 md:p-0 -top-5 -right-5"
                        >
                            <Button
                                @click="deleteConnection($event, connection)"
                                severity="danger"
                                rounded
                                icon="pi pi-trash"
                            />
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-y-6 p-3">
                            ...
                            <div v-else class="flex flex-wrap justify-center items-center gap-3 p-4">
                                ...
                                <div class="py-2 overflow-auto" v-if="connection.address">
                                    ...
                                    <SplittersRizersFind
                                        @change="(e) => (connection.end3 = e.value)"
                                        :init="connection.end3"
                                    />
                                </div>
                                ...
                                <div v-if="connection.end3 && connection.address">
                                    ...
                                    <SelectSplitterRizerPort
                                        :init="{ number: connection.end3Port, status: connection.status }"
                                        :end3ID="connection.end3.id"
                                        @change="
                                            (e) => {
                                                connection.end3Port = e.value.number;
                                                connection.tech_capability_id = e.value.id;
                                            }
                                        "
                                        :get-from="connection.end3"
                                        :type="connection.end3.type"
                            ...
                            <!-- ДАННЫЕ ONT -->
                            <div
                                class="flex gap-x-4 items-center p-2"
                                :class="editMode ? 'w-full flex-col' : 'flex-row'"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="64"
                                ...
                                <div v-if="editMode && hasPermissionToUpdateConnection" class="flex flex-col w-full">
                                    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-2">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <InputText
                                                v-model.trim="connection.ont_serial"
                                                type="text"
                                                fluid
                                                class="rounded-2xl"
                                            />
                                        ...
                                        <div class="w-full">
                                            ...
                                            <InputText
                                                v-model.trim="connection.ont_mac"
                                                type="text"
                                                fluid
                                                class="rounded-2xl"
                                            />
                            ...
                            <!-- ТРАНЗИТ и НАРЯД -->
                            <div
                                class="flex gap-3 p-3 items-center"
                        ...
                        <div v-if="editMode && hasPermissionToUpdateConnection" class="p-3">
                            ...
                            <div class="flex flex-wrap p-2">
                                <div class="me-2 flex items-center gap-2">
                                    <Checkbox
                                        v-model="connection.services"
                                        inputId="service-internet"
                                        value="internet"
                                    />
                        ...
                        <div class="p-3">
                            <Button
                                text
                                v-if="editMode"
                                @click="updateCustomerConnection(connection)"
                                class="save-button"
                                severity="success"
                            >
                                <svg
...
export default {
    ...
    computed: {
        ...
        hasPermissionToUpdate() {
            return ["gpon.change_customer", "gpon.change_subscriberconnection"].every((elem) => {
