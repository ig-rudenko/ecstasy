    ...
    <div class="mx-auto py-2 sm:py-6 lg:px-8">
        <div class="flex flex-col gap-4 sm:gap-6">
            <div class="flex flex-col gap-4 sm:gap-6 justify-center mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
                <section
                    class="relative overflow-hidden rounded-4xl border border-gray-200/70 dark:border-gray-700/70 dark:bg-gray-900/45 bg-white/80 backdrop-blur transition hover:-translate-y-0.5 delay-0 hover:bg-linear-to-br hover:from-transparent hover:via-transparent hover:to-indigo-500/10 hover:shadow-md"
                >
                    <div
                ...
                <section
                    class="rounded-4xl border border-gray-200/70 dark:border-gray-700/70 dark:bg-gray-900/45 bg-white/80 p-4 sm:p-6 backdrop-blur transition hover:-translate-y-0.5 delay-0 hover:bg-linear-to-br hover:from-transparent hover:via-transparent hover:to-indigo-500/10 hover:shadow-md"
                        ...
                        >
                            ...
                            <div class="overflow-x-auto mt-2">
                                <table class="min-w-300 w-full text-sm">
                                    <thead
                                        class="border-b border-gray-200/70 bg-gray-50/80 dark:border-gray-700/70 dark:bg-gray-900/70"
                                    >
