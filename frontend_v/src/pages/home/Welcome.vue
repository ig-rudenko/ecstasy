    ...
    const cards: ModuleCard[] = [
        {
            ...
            description:
                "Основной раздел для повседневной эксплуатации сети и просмотра состояния узлов без ручного ввода CLI-команд.",
            features: [
        ...
        },
        {
            ...
            description:
                "Инструменты для определения маршрута трафика и поиска проблемного участка между сетевыми устройствами.",
            features: [
        ...
        },
        {
            ...
            features: ["Поиск IP/MAC по сети", "Сопоставление с Zabbix", "Выход на нужное устройство и интерфейс"],
            icon: "pi pi-bolt",
            to: "/tools/wtf",
        ...
        },
        {
            ...
            description:
                "База GPON-подключений с техническими данными, адресной информацией, OLT/ONT и связью с абонентами.",
            features: ["Технические данные GPON", "OLT, ONT, адреса и подключения", "База пользователей и сервисов"],
            icon: "pi pi-sitemap",
            to: "/gpon",
                ...
                <section class="mt-8">
                    ...
                    <div class="mt-5 grid gap-4 xl:grid-cols-2">
                        ...
                        >
                            <div
                                :class="[
                                    'absolute inset-0 bg-linear-to-br opacity-90 transition group-hover:opacity-100',
                                    module.accent,
                                ]"
                            />
                            <div class="relative">
