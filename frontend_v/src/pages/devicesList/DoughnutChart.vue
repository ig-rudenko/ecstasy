<template>
    <div
        class="flex items-center flex-col justify-center h-full relative rounded-3xl border border-gray-200/80 bg-white/80 p-4 shadow-[0_14px_40px_-30px_rgba(15,23,42,0.35)] dark:border-gray-700/80 dark:bg-gray-950/35"
    >
        <div class="mb-4 flex items-center justify-between gap-3">
            ...
            <div
                class="rounded-2xl border border-gray-200/80 bg-gray-50/80 px-3 py-2 text-xs font-mono text-gray-600 dark:border-gray-700/80 dark:bg-gray-800/60 dark:text-gray-300"
            >
                {{ total }} портов
            </div>
        </div>
...
const chartColors = ["#166534", "#22c55e", "#fca5a5", "#cbd5e1", "#60a5fa"];
