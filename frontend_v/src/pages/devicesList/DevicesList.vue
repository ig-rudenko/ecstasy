                    ...
                    <div class="flex flex-col gap-8 xl:flex-row xl:items-start xl:justify-between">
                        <div class="max-w-4xl">
                            ...
                            <p class="mt-3 max-w-3xl text-sm leading-7 text-gray-600 dark:text-gray-300 sm:text-base">
                                Поиск по имени и IP, фильтры по вендору, модели и группе, закрепленные устройства и
                                режим сводной нагрузки по интерфейсам.
                            </p>
                        ...
                        <div class="hidden xl:block w-130 shrink-0">
                            ...
                            >
                                <img
                                    ...
                                    :src="`/img/device-icon-${imageIndex}.svg`"
                                    alt="devices"
                                />
                            </div>
                        </div>
                        ...
                        >
                            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                <div class="md:pl-6">
                                    ...
                                    <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                        По текущему набору устройств после фильтров.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                class="mt-5 md:m-5 sm:flex flex-wrap gap-6 xl:flex-row justify-center"
                            >
...
export default defineComponent({
    ...
    methods: {
        ...
        getDeviceWithStats(): void {
            ...
            devicesService
                .getDevicesListWithInterfacesWorkload()
                .then((devices) => {
                    this.devices = devices;
