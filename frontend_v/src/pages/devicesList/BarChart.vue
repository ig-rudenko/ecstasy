<template>
  <div class="rounded-[1.5rem] border border-gray-200/80 bg-white/80 p-4 shadow-[0_14px_40px_-30px_rgba(15,23,42,0.35)] dark:border-gray-700/80 dark:bg-gray-950/35">
