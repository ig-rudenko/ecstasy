<template>
  <div class="flex flex-wrap items-center gap-4">
    ...
    <div class="flex flex-wrap flex-col sm:flex-row font-mono items-center gap-4">
      <div class="text-xl sm:text-3xl">{{ deviceName }}</div>
    ...
    <div v-if="consoleUrl && consoleUrl.length > 0" style="position: absolute; right: 20px;">
