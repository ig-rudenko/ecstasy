<template>
    <div class="flex flex-col gap-4 h-full">
        ...
        <div
            id="drag-drop-area"
            class="flex flex-col gap-4 rounded-3xl border border-dashed border-gray-300/80 bg-gray-50/70 p-5 dark:border-gray-700/80 dark:bg-gray-800/40 h-full"
        >
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between h-full">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <label
                        for="file-input"
                        class="inline-flex cursor-pointer items-center gap-2 rounded-2xl border border-gray-200/80 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:border-sky-300 hover:text-sky-600 dark:border-gray-700/80 dark:bg-gray-900/60 dark:text-gray-200 dark:hover:border-sky-500 dark:hover:text-sky-300"
                    >
                        ...
                        <div class="flex flex-col gap-3">
                            <div>
                                ...
                                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Добавьте описание перед загрузкой.
                                </div>
                            </div>
                            ...
                            <FloatLabel variant="on">
                                <Textarea
                                    v-model.trim="fileObj.description"
                                    input-id="media-description"
                                    rows="7"
                                    fluid
                                    class="min-h-[10rem]"
                                />
...
export default defineComponent({
    ...
    methods: {
        ...
        uploadFile(mediaFile: MediaFile): Promise<number | void> | undefined {
            ...
            return api
                .post(`/api/v1/devices/${this.deviceName}/media`, formData, {
                    headers: {
                ...
                .catch((reason: any) => mediaFile.errors.push(errorFmt(reason)));
        },
    },
});
</script>
