      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h4 id="modal-mac-content" class="fs-5">
            <svg style="vertical-align: top" xmlns="http://www.w3.org/2000/svg" width="24" height="28"
                 fill="currentColor" class="bi bi-ethernet" viewBox="0 0 16 16">
              <path
...
export default defineComponent({
  ...
  methods: {
    getVendor() {
      if (!this.mac) return;
      api.get("/tools/api/mac-vendor/" + this.mac)
          .then(
    ...
    macDetail() {
      if (!this.mac) return;
      api.get("/tools/api/ip-mac-info/" + this.mac)
          .then(
