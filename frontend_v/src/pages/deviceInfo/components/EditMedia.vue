<template>
    <div id="edit-drag-drop-area" class="flex flex-col gap-4">
        <div
            class="flex flex-wrap items-center justify-between gap-3 rounded-3xl border border-gray-200/80 bg-gray-50/80 p-4 dark:border-gray-700/80 dark:bg-gray-800/40"
        >
            <div>
                <div class="text-sm font-semibold text-gray-900 dark:text-gray-100">Редактирование файла</div>
                <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Можно заменить файл или обновить описание.
                </div>
            </div>
        ...
        <div class="grid gap-4 xl:grid-cols-[minmax(0,0.95fr),minmax(0,1.05fr)]">
            ...
            >
                ...
                <label
                    for="edit-file-input"
                    class="inline-flex w-fit cursor-pointer items-center gap-2 rounded-2xl border border-gray-200/80 bg-gray-50 px-4 py-2 text-sm font-medium text-gray-700 transition hover:border-sky-300 hover:text-sky-600 dark:border-gray-700/80 dark:bg-gray-800/70 dark:text-gray-200 dark:hover:border-sky-500 dark:hover:text-sky-300"
                >
            ...
            >
                <FloatLabel variant="on">
                    <Textarea
                        ...
                        input-id="edit-media-description"
                        rows="12"
                        fluid
                        class="min-h-[18rem]"
                    />
