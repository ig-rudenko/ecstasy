  ...
  <div class="row" v-if="displayMode">
    ...
    <div class="col-auto">
      <svg @click="startEditDesc" style="cursor: pointer;"
           xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="grey" class="bi bi-pencil-square"
           viewBox="0 0 16 16">
        <path
  ...
  <div v-else class="input-group">
    ...
    <span class="input-group-text btn-float">
      <svg @click="displayMode=true"
           xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="grey" class="bi-check-circle-fill"
           viewBox="0 0 16 16">
        <path
    ...
    <span class="input-group-text btn-float" style="border-left: none">
      ...
      <svg v-show="!loading" @click="setDescription" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
           fill="#198754" class="bi-check-circle-fill" viewBox="0 0 16 16">
        <path
