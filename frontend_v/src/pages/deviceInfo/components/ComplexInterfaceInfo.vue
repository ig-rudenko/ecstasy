    ...
    [
        {
            ...
            activeClass:
                "border-slate-300 bg-slate-100 text-slate-900 dark:border-slate-600 dark:bg-slate-700/60 dark:text-slate-100",
        },
        {
            ...
            activeClass:
                "border-amber-300 bg-amber-50 text-amber-900 dark:border-amber-700 dark:bg-amber-500/15 dark:text-amber-100",
        },
        {
    ...
    <div class="flex flex-col gap-5">
        ...
        >
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <div class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                            Дополнительные данные и диагностика интерфейса.
                        </div>
                    </div>
                    ...
                    <div v-if="detailActions.length" class="flex flex-wrap gap-2">
                        <Button
                            ...
                            :class="['rounded-2xl!', portDetailMenu === action.key ? action.activeClass : '']"
                ...
                <div
                    v-if="portDetailMenu === 'portConfig'"
                ...
                <div
                    v-if="portDetailMenu === 'portErrors'"
                ...
                >
                    ...
                    <div
                        v-if="complexInfo.portErrors.length > 0"
                ...
                >
                    <DataTable
                        ...
                        :pt="{
                            ...
                            column: {
                                headerCell: {
                                    class: 'bg-gray-50/80 dark:bg-gray-900/80 border-b border-gray-200/80 dark:border-gray-700/80 text-xs uppercase tracking-[0.2em] text-gray-500 dark:text-gray-400',
                                },
                            },
                            pcPaginator: {
                                root: {
                    ...
                    >
                        <Column :sortable="true" header="VLAN" field="vlanID">
                            <template #body="{ data }">
                                <div
                                    ...
                                    v-tooltip.left="data.vlanName.toString()"
                                >
                                    {{ data.vlanID }}
                                </div>
                            </template>
                        ...
                        <Column :sortable="true" header="MAC" field="mac">
                            <template #body="{ data }">
                                <button
                                    class="cursor-pointer font-mono font-semibold text-indigo-600 transition hover:text-indigo-500 dark:text-indigo-300 dark:hover:text-indigo-200 border border-transparent hover:border-primary-500/30 px-3 py-1 rounded-2xl"
                        ...
                        <Column header="" field="mac">
                            <template #body="{ data }">
                                <Button
                                    size="small"
                                    @click="() => checkBrasSessions(data.mac)"
                                    text
                                    label="BRAS"
                                    class="rounded-xl!"
                                />
