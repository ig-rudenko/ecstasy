<template>
  <Button v-tooltip.bottom="'Карты узла сети'" text @click="toggleOverlay" style="color: #f200ff;" class="rounded-2xl shadow-sm border-none">
    ...
    <span v-if="mapsData.length" style="background-color: #f200ff;" class="rounded-full font-mono text-white px-2">{{ mapsData.length }}</span>
  </Button>

  <Popover ref="zabbixMapsOverlayPanel">
    <div>
      <div class="mb-3">Карты Zabbix где имеется данное оборудование</div>
