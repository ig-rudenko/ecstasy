<template>
    <Button
        v-tooltip.bottom="'Карты узла сети'"
        text
        @click="toggleOverlay"
        style="color: #f200ff"
    ...
    >
        ...
        <span
            v-if="mapsData.length"
            style="background-color: #f200ff"
            class="rounded-full font-mono text-xs sm:text-sm text-white px-1 sm:px-1.5"
            >{{ mapsData.length }}</span
        >
    </Button>
