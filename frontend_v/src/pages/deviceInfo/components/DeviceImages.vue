                        ...
                        >
                            <div class="flex items-start gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div
                                        class="mt-2 flex items-center gap-2 text-[11px] text-gray-400 dark:text-gray-500"
                                    >
                                        <i class="pi pi-clock" />
            ...
            <section class="flex min-h-[60vh] flex-col bg-white/70 p-4 dark:bg-gray-950/20 sm:p-6">
                ...
                >
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-300">
                        Действие необратимо. Файл будет удалён с устройства.
                    </div>
                ...
                <EditMedia
                    ...
                    @close="
                        editForm.show = false;
                        currentItem = items[editForm.itemIndex];
                    "
                ...
                <div v-else class="flex h-full flex-col gap-4">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            <Button
                                @click="showEditForm(currentItemIndex)"
                                icon="pi pi-pencil"
                                label="Редактировать"
                                severity="contrast"
                                outlined
                    ...
                    >
                        <img
                            class="max-h-[60vh] max-w-full rounded-2xl object-contain"
                            :src="currentItem.url"
                            alt="image"
                        />
                    </a>
