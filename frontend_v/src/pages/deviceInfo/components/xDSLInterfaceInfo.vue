<template>
    ...
    >
        ...
        >
            <div
                class="border-b border-gray-200/80 bg-gray-50/80 px-4 py-3 dark:border-gray-700/80 dark:bg-gray-900/70"
            >
                <div class="text-sm font-semibold text-gray-900 dark:text-gray-100">Параметры линии</div>
                <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Сравнение downstream и upstream по ключевым метрикам.
                </div>
            </div>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="bg-gray-50/70 dark:bg-gray-900/70">
                            <th
                                class="px-4 py-1 text-left text-[11px] font-semibold uppercase tracking-[0.22em] text-gray-500 dark:text-gray-400"
                            ></th>
                            <th
                                class="px-4 py-1 text-center text-[11px] font-semibold uppercase tracking-[0.22em] text-gray-500 dark:text-gray-400"
                            >
                                Downstream
                            </th>
                            <th
                ...
                <div class="overflow-hidden rounded-3xl">
                    ...
                    <div class="divide-y divide-gray-200/80 dark:divide-gray-700/80">
                        <button
                            ...
                            :key="profile[0]"
                            type="button"
                            class="grid w-full gap-1 md:grid md:grid-cols-12 md:items-center md:gap-4 px-4 py-4 text-left transition cursor-pointer hover:bg-gray-500/10 dark:hover:bg-gray-800/60"
                            @click="changePortProfile(profile[0], profile[1])"
                        >
                            <span class="font-mono text-sm text-gray-500 dark:text-gray-400 md:col-span-2">{{
                                profile[0]
                            }}</span>
                            <span class="font-medium text-gray-900 dark:text-gray-100 md:col-span-10">{{
                                profile[1]
                            }}</span>
                        </button>
                    </div>
