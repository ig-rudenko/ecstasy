        ...
        <div class="table-responsive-lg">
          <table class="table">
            ...
            <tr v-for="mac in MACs">
              ...
              <td>
                <button @click="sessionEvent(mac.mac, ontInterface.name)" type="button" class="btn btn-outline-primary"
...
export default defineComponent({
  ...
  methods: {
    ...
    getMacs() {
      if (!this.showDetailInfo) return
      api.get("/device/api/" + this.deviceName + "/macs?port=" + this.ontInterface.name)
          .then(
