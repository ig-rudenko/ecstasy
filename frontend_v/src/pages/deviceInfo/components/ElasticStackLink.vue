<template>
    <a :href="logsUrl" target="_blank">
        <Button text v-tooltip.bottom="'Логи оборудования'" class="rounded-2xl shadow-sm border-none">
            <svg data-type="logoElastic" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 32 32">
                <path
...
export default defineComponent({
    props: {
        logsUrl: { required: true, type: String },
    },
});
</script>
