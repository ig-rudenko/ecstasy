<template>
    <Button
        text
        @click="openDialog"
        v-tooltip.bottom="'Пользовательские действия'"
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Фильтрация по пользователю и тексту действия.
                        </div>
                    </div>
                ...
                <div v-if="filteredActions?.length" class="divide-y divide-gray-200/80 dark:divide-gray-700/80">
                    ...
                    >
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-11 w-11 items-center justify-center rounded-2xl bg-sky-100 text-sm font-semibold uppercase text-sky-700 dark:bg-sky-500/15 dark:text-sky-300"
                            >
                                {{ initials(act.user) }}
                            </div>
                            <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="mt-0.5 inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-300"
                            >
                                <i
                                    :class="actionIcon(act.action).icon"
                                    :style="{ color: actionIcon(act.action).color }"
                                />
                            </div>
                            <div class="min-w-0">
