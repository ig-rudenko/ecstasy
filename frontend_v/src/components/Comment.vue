<template>
    <div v-if="interface.comments && interface.comments.length" class="inline-flex relative">
        <span
            ...
            >{{ interface.comments?.length }}</span
        >
        <Button
            ...
            :pt="{
                root: {
                    class: 'hover:shadow-sm hover:border-gray-300/90 dark:hover:border-gray-700/60 bg-white/60 dark:bg-gray-900/25 backdrop-blur-sm hover:bg-white/85 dark:hover:bg-gray-900/45 transition',
                },
                label: { class: 'hidden' },
            }"
        >
        ...
        <Popover
            ...
            :pt="{
                root: {
                    class:
                        'before:hidden! overflow-hidden rounded-2xl border border-gray-200/80 ' +
        ...
        >
            <div class="w-[min(32rem,calc(100vw-2rem))]">
                ...
                >
                    <div>
                        <div class="text-sm font-semibold text-gray-900 dark:text-gray-100">Комментарии интерфейса</div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div
                                        ...
                                        v-html="
                                            textToHtml(markedText ? markText(comment.text, markedText) : comment.text)
                                        "
                                    />
                                </div>
