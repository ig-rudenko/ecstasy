                ...
                <div class="max-h-[55vh] overflow-auto">
                    ...
                    <template v-else>
                        <div
                            ...
                            :key="data.id"
                            :class="
                                selectedCommandId === data.id
                                    ? 'bg-sky-50/80 ring-1 ring-sky-500/20 dark:bg-sky-950/20'
                        ...
                        <div v-if="!filteredCommands.length" class="px-4 py-10 text-center">
