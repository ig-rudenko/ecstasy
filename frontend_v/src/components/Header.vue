...
<template>
                ...
                <div class="hidden lg:block relative">
                    <Menubar
                        ...
                        :pt="{
                            ...
                            itemContent: {
                                class: '!bg-transparent rounded-2xl hover:!bg-white/70 dark:hover:!bg-gray-900/50 transition',
                            },
    ...
    <Drawer
        ...
        :pt="{
            root: {
                class:
                    'border-none shadow-none! dark:bg-gray-900/55! dark:backdrop-blur-xl ' +
    ...
    >
        ...
        <div class="flex flex-col gap-2">
            ...
            >
                <div
                    :class="
                        isCurrent(item.url || '_') ? 'ring-2 ring-indigo-500/50 bg-white/70 dark:bg-gray-900/40' : ''
                    "
    ...
    <Popover
        ...
        :pt="{
            root: {
                class:
                    'before:hidden! overflow-hidden rounded-2xl border-gray-100/30! ' +
    ...
    >
        <div class="p-3">
            ...
            <div class="flex gap-1 items-center justify-center mt-3">
                ...
                <Button
                    icon="pi pi-sun"
                    v-if="currentTheme == 'dark' || currentTheme == 'auto'"
                    @click="toggle"
