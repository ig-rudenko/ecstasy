...
Для выбора стабильной версии желательно переходить по тегам, смотрите [релизы](https://github.com/ig-rudenko/ecstasy/releases).
Тег указывается без пробельных символов.
