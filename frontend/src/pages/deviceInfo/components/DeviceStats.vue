  ...
  <div>
    <div v-if="stats.temp" style="padding: 7px 13px;">
      ...
      <svg v-if="stats.temp.status === 'low'"
           xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#0d6efd" class="bi bi-thermometer"
           viewBox="0 0 16 16">
      ...
      <svg v-else-if="stats.temp.status === 'normal'"
           xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#198754" class="bi bi-thermometer-low"
           viewBox="0 0 16 16">
      ...
      <svg v-else-if="stats.temp.status === 'medium'"
           xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ff9836" class="bi bi-thermometer-half"
           viewBox="0 0 16 16">
      ...
      <svg v-else-if="stats.temp.status === 'high'"
           xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#dc3545" class="bi bi-thermometer-high"
           viewBox="0 0 16 16">
    ...
    <div v-else style="padding: 7px 13px;">
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="grey" class="bi bi-thermometer"
           viewBox="0 0 16 16">
        <path d="M8 14a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
        <path
            d="M8 0a2.5 2.5 0 0 0-2.5 2.5v7.55a3.5 3.5 0 1 0 5 0V2.5A2.5 2.5 0 0 0 8 0zM6.5 2.5a1.5 1.5 0 1 1 3 0v7.987l.167.15a2.5 2.5 0 1 1-3.333 0l.166-.15V2.5z"/>
