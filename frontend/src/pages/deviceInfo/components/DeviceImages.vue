<template>
  ...
  <button v-tooltip.bottom="'Медиафайлы'" type="button" class="btn" data-bs-toggle="modal"
          data-bs-target="#device-media-modal"
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" :fill="mediaToggleButtonColor" class="me-2" viewBox="0 0 16 16">
    ...
    <span v-if="items.length" class="badge bg-success">{{ items.length }}</span>
</button>
