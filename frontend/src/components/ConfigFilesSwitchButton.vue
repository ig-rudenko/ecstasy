<template>
  <div v-tooltip.bottom="'Конфигурации'" @click="configFiles.display=!configFiles.display">
    ...
    <button class="btn" style="width: 100%; text-align: left">
      ...
      <svg v-if="!configFiles.display" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="me-2" viewBox="0 0 16 16">
      ...
      <svg v-else xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="me-2" viewBox="0 0 16 16">
