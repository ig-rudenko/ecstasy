...
class DeviceGroupTest(TestCase):
    ...
    def test_name_label(self):
        g = DeviceGroup.objects.get(id=1)
...
class DeviceRelationsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Devices.objects.create(
            name="Test Name", ip="192.168.123.123", group=group, auth_group=auth
        )
...
class BrasTest(TestCase):
    ...
    def setUpTestData(cls):
        Bras.objects.create(
            name="BRAS", ip="192.168.1.1", login="login", password="password"
        )
...
class ProfileTest(TestCase):
    ...
    def setUpTestData(cls):
        u = User(
            first_name="First_Name", email="email@email.com", username="first_user"
        )
